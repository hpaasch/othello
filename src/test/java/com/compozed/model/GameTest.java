...
public class GameTest {
    ...
    public void testSaveGameHistory() throws Exception {
        ...
        System.out.println(game.getHistory().get(0).toString());

        System.out.println(game.getHistory().get(1).toString());


        assertEquals( "first element in history should not know about second move", 0, game.getHistory().get(0).getState()[2][5] );
        assertEquals( "second element in history should know about second move", 2, game.getHistory().get(1).getState()[2][5] );
    }
