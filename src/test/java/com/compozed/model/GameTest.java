...
//
//        System.out.println(currentBoard.toString());
//        assertEquals("Cell 5,2 is a possible move for white", GamePiece.WhitePossible, currentBoard.getPiece(5,2));
//        assertEquals("Cell 5,3 is a possible move for white", GamePiece.WhitePossible, currentBoard.getPiece(5,3));
//        assertEquals("Cell 5,4 is a possible move for white", GamePiece.WhitePossible, currentBoard.getPiece(5,4));
//    }
}
